...
```
docker run --rm quay.io/nordstrom/fluent-bit:1.3.2-debug ps -o user=----------
```
...
```
docker run quay.io/nordstrom/fluent-bit:1.3.2 /fluent-bit/bin/fluent-bit -i cpu -o stdout -f 1
```
